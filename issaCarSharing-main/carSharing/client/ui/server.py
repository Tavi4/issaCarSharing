...
cars = {
    "1HGCM82633A123456": {"location": "Palas", "available": False, "lights": False, "doors_locked": True, "client_id": None},
    "1FAHP2E85BG120500": {"location": "Podu Ros", "available": True, "lights": False, "doors_locked": True, "client_id": None},
    "JH4KA9650MC123789": {"location": "Mall", "available": True, "lights": False, "doors_locked": True, "client_id": None},
}
...
def handle_client(client_socket):
    try:
        ...
        # ------------- Query cars -------------
            ...
            available_cars = {vin: car for vin, car in cars.items()}
        ...
        # ------------- Start rental -------------
            ...
            if cars.get(vin) and cars[vin]["available"]:
                ...
                available_cars = {vin: car for vin, car in cars.items()}
                response = {"status": "success", "message": f"Car {vin} rental started!","cars": available_cars}
            else:
